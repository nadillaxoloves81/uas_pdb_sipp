...
@section('title', 'Penduduk Semua Nagari')
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Daftar Penduduk di Semua Nagari</h2>
                <a href="{{ route('cetakPendudukNagari') }}" class="btn btn-round btn-primary pull-right" target="_blank"><i class="fa fa-print"></i> Cetak</a>
            ...
            <form method="post" action="{{ route('pendudukNagari') }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                @csrf
