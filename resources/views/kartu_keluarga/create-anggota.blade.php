...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Tambah Anggota Keluarga (No. KK: {{ $kartu_keluarga_id->no }})</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form method="post" action="{{ route('anggotaKeluarga.store') }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12 @error('kartu_keluarga_id') is-invalid @enderror" value="{{ $kartu_keluarga_id->no }}" disabled>
                            <input type="hidden" name="kartu_keluarga_id" id="kartu_keluarga_id" value="{{ $kartu_keluarga_id->id }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <a href="{{ route('kartuKeluarga.show', ['id' => $kartu_keluarga_id]) }}" class="btn btn-primary" type="button">Cancel</a>
